...
import '../provider/contraints.dart';

class SelectedCityContrainsts extends StatelessWidget {
  String name;
  int id;
  SelectedCityContrainsts({required this.id, required this.name});
    ...
    return Consumer<ConstraintsProvider>(
      builder: (context, value, child) {
        ...
        return Padding(
          ...
          child: InkWell(
            onTap: () {
              constraintsProvider.removeCity(id,name);
            },
            child: Container(
